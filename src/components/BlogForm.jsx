...
const BlogForm = ({ onAdd }) => {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(45deg, #ff6b81, #f06595)" }}
    >
      {!isFormVisible ? (
        <button
          onClick={() => setIsFormVisible(true)}
          className="btn btn-lg text-white fs-5"
          style={{
        ...
        <form
          ...
          className="w-100 w-md-75 w-lg-50 p-5 bg-white shadow-lg rounded-4 border-0"
          style={{
            boxShadow: "0 4px 30px rgba(0, 0, 0, 0.1)",
          }}
        >
          <h2 className="text-center text-dark mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Create a New Blog
          </h2>
          <div className="mb-4">
          ...
          <button
            ...
            onMouseOver={(e) => (e.target.style.background = "#f06595")}
            onMouseOut={(e) => (e.target.style.background = "linear-gradient(45deg, #ff6b81, #f06595)")}
          >
            Publish Blog
          </button>
        </form>
